...
如果你需要手动将克隆的仓库与上游仓库同步（例如 GitHub Actions 运行失败并出现合并冲突），请按照以下步骤进行：
1. 删除原始的仓库；
2. 使用页面右上角的 fork 按钮，fork 本项目；
3. 在 Vercel 中重新选择并部署，[请查看详细教程](./docs/vercel-cn.md#如何新建项目)。

### 自动更新选项

你也可以启用自动更新，详细教程请参阅 [此处的教程](https://github.com/Yidadaa/ChatGPT-Next-Web#enable-automatic-updates).
